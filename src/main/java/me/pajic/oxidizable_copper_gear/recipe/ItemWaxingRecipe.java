...
public class ItemWaxingRecipe extends CustomRecipe {
            ...
            for (int i = 0; i < input.size(); i++) {
                ...
                if (!itemStack.isEmpty()) {
                    if (itemStack.is(Items.HONEYCOMB)) {
                        ...
                        if (!itemStack.is(ModTags.OXIDIZABLE) || itemStack.has(ModDataComponents.WAXED)) return false;
    ...
    public @NotNull ItemStack assemble(CraftingInput input, @NotNull HolderLookup.Provider registries) {
        ...
        for (int i = 0; i < input.size(); i++) {
            ...
            if (itemStack2.is(ModTags.OXIDIZABLE)) {
                ...
                itemStack.set(ModDataComponents.WAXED, true);
            }
        }
        return itemStack;
    }
    ...
    public @NotNull RecipeSerializer<? extends CustomRecipe> getSerializer() {
        return ModRecipeSerializers.ITEM_WAXING;
    }
}
